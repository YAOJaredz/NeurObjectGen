#!/bin/bash
# Sweep LSTM encoder hyperparameters via SLURM job arrays.

#SBATCH --job-name=lstm_sweep
...
#SBATCH --output=/home/yy3658/NeurObjectGen/jobs/logs/lstm_sweep_%A_%a.log
#SBATCH --array=0-23%5        # 3 hiddens x 2 dropouts x 2 lrs x 2 wds = 24
...
echo "Task ${SLURM_ARRAY_TASK_ID}: hidden=${HIDDEN} dropout=${DROPOUT} lr=${LR} wd=${WD}"
