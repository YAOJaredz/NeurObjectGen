...
#
# Grid: loss_weight_t5 x d_model x n_layers x shared_dim x t5_pca_k x nce_weight = 3x2x2x2x2x2 = 96 runs
#   loss_weight_t5: 0.0 (2-head ablation), 0.1, 0.5
#   d_model:        64, 128
#   n_layers:       2, 4
#   shared_dim:     256, 512
#   t5_pca_k:       128, 256
#   nce_weight:     0.0 (pure cosine baseline), 0.8 (InfoNCE primary)
#
...
#SBATCH --array=0-95%16        # 96 runs, max 8 concurrent
...
# 3 x 2 x 2 x 2 x 2 x 2 = 96 total
