#!/bin/bash
# Sweep LSTM encoder — clip target.
# Grid: 4 hiddens x 2 n_layers x 1 dropout x 2 lrs x 2 wds = 32 jobs.

#SBATCH --job-name=lstm_clip_sweep
...
#SBATCH --output=/home/yy3658/NeurObjectGen/jobs/logs/lstm_clip_sweep_%A_%a.log
#SBATCH --array=0-31%8   # 4 hiddens x 2 n_layers x 1 dropout x 2 lrs x 2 wds = 32
